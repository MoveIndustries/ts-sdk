...
This directory contains tests for the Move Industries confidential assets functionality. The tests are organized into:
...
3. Access to a Movement testnet node

## Environment Variables

The tests use environment variables to determine which accounts to use:

- `TESTNET_PK`: Private key for the Movement account used in tests
