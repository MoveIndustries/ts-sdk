...
export async function getDigitalAssetData(args: {
  ...
  const { movementConfig, digitalAssetAddress } = args;
...
export async function getOwnedDigitalAssets(args: {
  ...
  const { movementConfig, ownerAddress, options } = args;
...
export async function getDigitalAssetActivity(args: {
  ...
  const { movementConfig, digitalAssetAddress, options } = args;
...
export async function createCollectionTransaction(
  ...
  const { movementConfig, options, creator } = args;
...
export async function getCollectionDataByCreatorAddressAndCollectionName(args: {
  ...
  const { movementConfig, creatorAddress, collectionName, options } = args;
  ...
  return getCollectionData({ movementConfig, options: { ...options, where: whereCondition } });
}
...
export async function getCollectionDataByCreatorAddress(args: {
  ...
  const { movementConfig, creatorAddress, options } = args;
  const address = AccountAddress.from(creatorAddress);
...
export async function getCollectionDataByCollectionId(args: {
  ...
  const { movementConfig, collectionId, options } = args;
...
export async function getCollectionId(args: {
  ...
  const { creatorAddress, collectionName, options, movementConfig } = args;
  const address = AccountAddress.from(creatorAddress);
  ...
  return (await getCollectionData({ movementConfig, options: { where: whereCondition } })).collection_id;
}
...
export async function transferDigitalAssetTransaction(args: {
  ...
  const { movementConfig, sender, digitalAssetAddress, recipient, digitalAssetType, options } = args;
  return generateTransaction({
    movementConfig,
...
export async function burnDigitalAssetTransaction(args: {
  ...
  const { movementConfig, creator, digitalAssetAddress, digitalAssetType, options } = args;
  return generateTransaction({
    movementConfig,
    sender: creator.accountAddress,
    data: {
...
export async function setDigitalAssetDescriptionTransaction(args: {
  ...
  const { movementConfig, creator, description, digitalAssetAddress, digitalAssetType, options } = args;
  return generateTransaction({
    movementConfig,
    sender: creator.accountAddress,
    data: {
...
export async function setDigitalAssetNameTransaction(args: {
  ...
  const { movementConfig, creator, name, digitalAssetAddress, digitalAssetType, options } = args;
  return generateTransaction({
    movementConfig,
    sender: creator.accountAddress,
    data: {
...
export async function setDigitalAssetURITransaction(args: {
  ...
  const { movementConfig, creator, uri, digitalAssetAddress, digitalAssetType, options } = args;
  return generateTransaction({
    movementConfig,
    sender: creator.accountAddress,
    data: {
...
export async function removeDigitalAssetPropertyTransaction(args: {
  ...
  const { movementConfig, creator, propertyKey, digitalAssetAddress, digitalAssetType, options } = args;
  return generateTransaction({
    movementConfig,
    sender: creator.accountAddress,
    data: {
