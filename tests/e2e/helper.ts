...
/**
 * Use this function whenever you want an Movement client.
 *
 ...
 *    export MOVEMENT_NETWORK=devnet.
 ...
 * MOVEMENT_NETWORK=devnet and APTOS_NODE_API_URL=http://localhost:8080, it will use the
 * given URL for the node API and the default URLs for devnet for the other APIs.
 */
export function getAptosClient(additionalConfig?: MovementSettings): { aptos: Movement; config: MovementConfig } {
