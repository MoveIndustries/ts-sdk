  ...
  describe("Single Sender ED25519", () => {
    ...
    describe("single signer", () => {
      test("with script payload", async () => {
        ...
        const [response] = await movement.transaction.simulate.simple({
    ...
    describe("multi agent", () => {
      test("with script payload", async () => {
        const rawTxn = await movement.transaction.build.multiAgent({
          sender: singleSignerED25519SenderAccount.accountAddress,
        ...
        const [response] = await movement.transaction.simulate.multiAgent({
          signerPublicKey: singleSignerED25519SenderAccount.publicKey,
          transaction: rawTxn,
